...
Endpoint.prototype._initializeDataFlow = function _initializeDataFlow(role, settings, filters) {
  ...
  this._serializer.on('end', this._onEnd.bind(this));
};
...
Endpoint.prototype._onFinish = function _onFinish() {
  this._deserializer.end();
};

Endpoint.prototype._onEnd = function _onFinish() {
  this.push(null);
};
...
Endpoint.prototype.goaway = function close(error) {
  this._connection.goaway(error);
};
