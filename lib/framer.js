...
Deserializer.commonHeader = function readCommonHeader(data) {
  var frame = {}
...
Deserializer['DATA'] = function readData(data) {
  return { data: data }
}
...
Deserializer['HEADERS+PRIORITY'] = function readHeadersPriority(data) {
  return {
...
Deserializer['PRIORITY'] = function readPriority(data) {
  return {
...
Deserializer['RST_STREAM'] = function readRstStream(data) {
  return {
...
Deserializer['SETTINGS'] = function readSettings(data) {
...
Deserializer['PUSH_PROMISE'] = function readPushPromise(data) {
  return {
...
Deserializer['PING'] = function readPing(data) {
  return {
    data: data
  }
}
...
Deserializer['GOAWAY'] = function readGoaway(data) {
  return {
...
Deserializer['HEADERS'] = function readHeaders(data) {
  return { data: data }
}
...
Deserializer['WINDOW_UPDATE'] = function readWindowUpdate(data) {
  return {
