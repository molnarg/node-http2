...
// [3]: http://tools.ietf.org/html/draft-ietf-httpbis-http2-07#section-8.1.3.2
...
// The implemented version of the HTTP/2 specification is [draft 07][1].
// [1]: http://tools.ietf.org/html/draft-ietf-httpbis-http2-07
...
// [Request Header Fields](http://tools.ietf.org/html/draft-ietf-httpbis-http2-07#section-8.1.3.1)
...
// [Response Header Fields](http://tools.ietf.org/html/draft-ietf-httpbis-http2-07#section-8.1.3.2)
// * `headers` argument: HTTP/2.0 request and response header fields carry information as a series
//   of key-value pairs. This includes the target URI for the request, the status code for the
//   response, as well as HTTP header fields.
