...
//   - **response.writeHead(statusCode, [reasonPhrase], [headers])**: not implemented
...
//   - **response.headersSent**: not implemented
//   - **response.sendDate**: not implemented
//   - **response.getHeader(name)**: not implemented
//   - **response.removeHeader(name)**: not implemented
//   - **response.write(chunk, [encoding])**: not implemented
//   - **response.addTrailers(headers)**: not implemented
//   - **response.end([data], [encoding])**: not implemented
// - **http.request(options, callback)**: not implemented
// - **http.get(options, callback)**: not implemented
// - **Class: http.Agent**
//   - **agent.maxSockets**: not implemented
//   - **agent.sockets**: not implemented
//   - **agent.requests**: not implemented
// - **http.globalAgent**: not implemented
// - **Class: http2.ClientRequest**
//   - **Event 'response'**: not implemented
//   - **Event: 'socket'**: not implemented
//   - **Event: 'connect'**: not implemented
//   - **Event: 'upgrade'**: not implemented
//   - **Event: 'continue'**: not implemented
//   - **request.write(chunk, [encoding])**: not implemented
//   - **request.end([data], [encoding])**: not implemented
