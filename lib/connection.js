...
function Connection(firstStreamId, settings, log) {
  ...
  this._initializeControlStream();

  this._initializeSettingsManagement();
...
Connection.prototype._initializeControlStream = function _initializeControlStream() {
...
Connection.prototype._initializeSettingsManagement = function _initializeSettingsManagement() {
