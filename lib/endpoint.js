...
function Endpoint(role, settings, log) {
  ...
  //   prelude and determining the id of the first stream to be created.
  var firstStreamId;
  switch(role) {
    case 'CLIENT':
      this._writePrelude();
  ...
  // * Second part of the handshake process: sending the first SETTINGS frame.
  //   This is done by the connection class right after initialization.
